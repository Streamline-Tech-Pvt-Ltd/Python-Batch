...
# Keywords
  Keywords are reserved words in Python that have special meanings and predefined functions. 
...
# f-string in python
  An f-string (formatted string) is used to insert variables or expressions directly inside a 
 ...
 * Ex: 1) name = input("Enter your name: ")
          print("Hello", name)
